...
If $\{x_n\}$ does not converge, we say it diverge\footnote{The formal definition of being divergent can be expressed as: If for every $x \in X$, there exists $\varepsilon > 0$ such that for all $N \in \mathbb{N}$, there is $n \geq N$, $d(x_n,x) > \varepsilon$.}.
\end{definition}
...
\begin{theorem}
For $a > 0$, $\lim_{n\to\infty} \sqrt[n]{a} = 1$.
\end{theorem}
\begin{proof}
If $a > 1$, let $x_n = \sqrt[n]{a} - 1$. By the Binomial formula,\footnote{For $a, b \in \mathbb{R}$ and $n \in \mathbb{N}$, \begin{align*}
...
\begin{theorem}
For $n \in \mathbb{N}$, $\lim_{n\to\infty} \sqrt[n]{n} = 1$.
\end{theorem}
\begin{proof}
Let $x_n = \sqrt[n]{n} - 1$, then $x_n > 0$ and applying the Binomial formula implies that 
\begin{align*}
